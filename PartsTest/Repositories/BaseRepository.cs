...
namespace PartsTest.Repositories
{
    ...
    public class RepositoryBase<TEntity, TIdentifier> : IBaseRepository<TEntity, TIdentifier> where TEntity : EntityDTO

    {
        ...
        public static string ElasticsearchType { get; private set; }
